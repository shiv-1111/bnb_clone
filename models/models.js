...
reviewSchema.post("save", async function () {
  ...
  let propertyReviewed = await Property.findOne({
    propertyID: this.propertyID,
  });
  propertyReviewed.reviews++;
  propertyReviewed.rating =
    ((propertyReviewed.rating == "New"
      ? 0
      : parseFloat(propertyReviewed.rating)) *
      (propertyReviewed.reviews - 1) +
      this.rating) /
    propertyReviewed.reviews;
